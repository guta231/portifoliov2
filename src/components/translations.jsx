...
const translations = {
    pt:{
        ...
        certifications: "Todos os certificados: ",
    },
    en:{
        projects: "Projects",
        contacts: "Contacts",
        skills: "Skills",
        about: "About",
        about_text: "Student of Software Engineering at FIAP - Faculty of Informatics and Administration Paulista, with extensive general knowledge in technology and a continuous commitment to learning. I have a strong interest in DevSecOps in cloud. I am flexible and versatile, able to adapt to different areas, and have a great thirst for knowledge.",
        ...
        certifications: "All the certifications: ",
    },
};
